...
import Hinata.modules.fun_strings as fun_strings
from Hinata import JONINS, CHUNINS, dispatcher
from Hinata.modules.disable import (
...
def slap(update: Update, context: CallbackContext):
    ...
    if user_id == bot.id:
        temp = random.choice(fun_strings.SLAP_Hinata_TEMPLATES)
...
def gbun(update, context):
    ...
    if update.effective_message.chat.type == "private":
        return
    if int(user.id) in JONINS or int(user.id) in CHUNINS:
